...
export function EntityDrawer() {
	...
	return (
		<div
			ref={drawerRef}
			popover="manual"
			className="absolute flex flex-col top-0 left-0 bottom-0 w-64 h-full bg-slate-800 -translate-x-full starting:open:-translate-x-full open:translate-x-0 transition-all duration-300 transition-discrete"
		>
