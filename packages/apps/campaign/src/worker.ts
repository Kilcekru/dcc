...
export const Triggers = {
    ...
    getMapUpdate: () => sendWorkerMessage({
        name: "getMapUpdate",
    }),
    // load the campaign state in the campaign logic worker
    load: (state: Types.Campaign.WorkerState) => sendWorkerMessage({
        name: "load",
        state,
    }),
    resume: (multiplier: number) => sendWorkerMessage({
        name: "resume",
        payload: {
            multiplier: multiplier,
        },
    }),
    pause: () => sendWorkerMessage({
        name: "pause",
    }),
}