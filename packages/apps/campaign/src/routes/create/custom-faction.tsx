...
import { ArrowLeft, ChevronRight, Flag, Plane, Shield, Target, Zap, Check, Info, Crosshair, AlertTriangle, LifeBuoy, Send, Radar } from "lucide-react"
...
function CustomFaction() {
    ...
    const roles: Role[] = [
        ...
        },
        {
            id: "CSAR",
            name: "CSAR",
            description: "Aircraft specialized in locating and rescuing downed aircrew and other personnel in hostile environments.",
            icon: LifeBuoy,
            color: "#00ff88",
        },
        {
            id: "AWACS",
            name: "AWACS",
            description: "Aircraft equipped with radar and other sensors to provide all-weather surveillance, command, control, and communications.",
            icon: Radar,
            color: "#00aaff",
        },
    ]
                                    ...
                                    <TabsList className="mb-4 grid w-full auto-rows-min gap-2 bg-[#0b0014] sm:grid-cols-3 lg:grid-cols-5 h-[4rem]">
                                        {roles.map((role) => (
                                            <TabsTrigger
                                                ...
                                                value={role.id}
                                                className={cn(
                                                    "flex items-center gap-1.5 data-[state=active]:bg-[#0b0014]",
                                                )}
                                                style={{
                                                        ...
                                                        <div className="mb-3 flex items-center gap-3">
                                                            <div>
                                                                ...
                                                                <div className="flex gap-2">
                                                                    ...
                                                                    {aircraft.isMod ? <Badge className="mt-1 bg-pink-600/10 text-pink-600">Mod</Badge> : null}
                                                                    {aircraft.isHelicopter ? <Badge className="mt-1 bg-green-600/10 text-green-600">Helicopter</Badge> : null}
