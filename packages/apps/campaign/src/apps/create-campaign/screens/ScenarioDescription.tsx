	...
	return (
		<Components.ScrollContainer>
			<div class={Styles.wrapper}>
				...
				<p>
					The United States, along with several other Western nations, came to the aid of Georgia during the conflict.
					The U.S. provided diplomatic, economic, and military support to Georgia, including the deployment of military
					forces.
				</p>
				<p>
					Main goal for the NATO coalition is the <strong>recapture of the Enguri Dam</strong>. To limit the damage to
					the Geogian infrastructure
				</p>
